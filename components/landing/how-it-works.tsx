      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="space-y-6">
          {steps.map((step, idx) => (
            <div
              key={idx}
              className="glass-effect group flex items-center gap-6 rounded-3xl p-8 transition-all duration-300 hover:scale-105"
            >
              <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-white text-3xl font-bold text-[oklch(47.747%_0.19594_29.223)]">
                {step.number}
              </div>
              <div>
